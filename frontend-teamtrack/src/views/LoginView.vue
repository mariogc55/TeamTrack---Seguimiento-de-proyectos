        ...
        async login() {
            ...
            try {
                const response = await apiClient.post('/users/login', {
                    correo: this.email, // Usa 'correo' según el backend
                ...
                // Recargar para que App.vue detecte el nuevo rol/token
...
<style scoped>
/* Estilos para asegurar que los inputs y el formulario sean visibles */
.login-container {
    padding: 2.5rem;
    max-width: 450px;
    margin: 80px auto; 
...
input {
    background-color: #333; /* Fondo visible */
